...
const MyBookings = () => {
    ...
    return (
        <div>
            <Title title='My Bookings' subTitle='Easily manage your past, current, and upcoming room reservations on one place. Plan your accommodation seamlessly with just a few clicks.' align='left'/>
